...
fileName="http://www.mbangas.com/bibleshow/bibles/"+strBible;req=ReadFile(fileName);if(req.status==200||req.status==0){strOutput=req.responseText;SQLImport(strOutput,dbSource,importComplete);}else{NSB.MsgBox("An error was experienced reading the bible named "+strName);NSB.WaitCursor(False);}
return savethefunction_rvar;}
