...
var dbBible;function Main(){var strBible;SaveSetting("onbooks","0");SaveSetting("onpromise","0");strBible=GetSetting("bible");if(Len(strBible)==0){strBible="King James Version";SaveSetting("bible",strBible);SaveSetting(strBible,"KJV");}
NSB.MsgBoxStyle="";sqlList=[];dbName="bibleshow.db";dbObj=SqlOpenDatabase(dbName);if(dbObj==0){NSB.MsgBox("Error opening bibleshow database!");}}
