...
var strBibleFile;var dbBible;function Main(){document.addEventListener("backbutton",onBackButton,False);document.addEventListener("menubutton",onMenuButton,False);var strBible;SaveSetting("onbooks","0");SaveSetting("onpromise","0");strBible=GetSetting("bible");if(Len(strBible)==0){strBible="King James Version";SaveSetting("bible",strBible);SaveSetting(strBible,"KJV");}
NSB.MsgBoxStyle="";sqlList=[];}
function onBackButton(){savethefunction_rvar="";var strCForm;strCFrom=NSBCurrentForm.id;switch(True){case((strCFrom)=="frmBibles"):ChangeForm(WhatToDo);break;case((strCFrom)=="frmBooks"):ChangeForm(frmBibles);break;case((strCFrom)=="frmPromises"):ChangeForm(WhatToDo);break;case((strCFrom)=="frmVerses"):switch(True){case((sourceForm)=="WhatToDo"):ChangeForm(WhatToDo);break;case((sourceForm)=="frmPromise"):ChangeForm(frmPromise);break;case((sourceForm)=="frmBooks"):ChangeForm(frmBooks);break;}
break;case((strCFrom)=="frmAbout"):ChangeForm(WhatToDo);break;case((strCFrom)=="frmPromise"):ChangeForm(frmPromises);}
return savethefunction_rvar;}
function onMenuButton(){savethefunction_rvar="";ChangeForm(WhatToDo);return savethefunction_rvar;}
